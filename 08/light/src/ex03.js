...
// ----- 주제: PointLight (전구와 같이 한 지점에서 3차원 전방향으로 나가는 빛)
/* arguments: (color, intensity, distance, default)
intensity: 빛의 강도(양)
distance: 0 means no limit
decay: 거리에 따라 빛의 강도가 떨어지는 정도 default:1, 물리적인 표현 원하면 2로 설정
*/
...
export default function example() {
  ...
  // const light = new THREE.PointLight("white", 1); // PoinLight (전구 빛)
