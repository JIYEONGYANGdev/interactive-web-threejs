...
export default function example() {
  ...
  // Controls
  const controls = new TrackballControls(camera, renderer.domElement); // 트랙볼처럼 360도 컨트롤되는 것
  // 기본적으로 enableDamping 이 적용되어있는 control
  controls.maxDistance = 20;
  controls.minDistance = 5; // zoom in & out distance restriction
